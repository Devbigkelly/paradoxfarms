<div class="row">
         <div class="col-md-12">
			<div class="card card-primary card-outline">
			  ...
			  <div class="card-body">
				<form method="post" action="<?php echo base_url('admin/profile/do-update/avatar');?>" enctype="multipart/form-data">
          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              <form class="form-horizontal" method="post" action="<?php echo base_url('admin/profile/do-update');?>">
              <div class="card-header">
