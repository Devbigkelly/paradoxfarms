<div class="row">
<?php if ($this->returns->permission_access('users_update_avatar', $logged_username)){?>
         <div class="col-md-12">
			<div class="card card-primary card-outline">
			  ...
			  <div class="card-body">
				<form method="post" action="<?php echo base_url('admin/users/do-update-avatar/'.$data[0]['username']);?>" enctype="multipart/form-data">
...
<?php } ?>
<?php if ($this->returns->permission_access('users_edit', $logged_username)){?>
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              <form class="form-horizontal" method="post" action="<?php echo base_url('admin/users/do-update-profile/'.$data[0]['username']);?>">
              <div class="card-header">
