<div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/email-templates/update');?>">
			  ...
			  <div class="card-body">
                      ...
                      <div class="form-group row">
						...
						<label for="" class="form-label">SUBJECT*</label>
						  <input type="text" class="form-control" id="" value="<?php echo $data[0]['subject'];?>" name="subject" placeholder="Email Subject" required>
						</div>
					  </div>
					  <?php 
					$stats = array(
	  ...
	  <div class="form-group row">
		...
		<textarea id="editor" class="form-control" name="message" placeholder="Email Body" required><?php echo $data[0]['message'];?></textarea>
		</div>
	  </div>
