<div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              <form class="form-horizontal" method="post" action="<?php echo base_url('admin/roles/adding');?>">
			  ...
			  <div class="card-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="" name="title" placeholder="Role Title" required>
                        </div>
                      </div>
					  ...
					  <div class="form-group row">
                        ...
                        <div class="col-sm-9">
							...
							<table class="table" border="1">
								...
								<tr>
									<td>
										<input type="checkbox" id="chk_<?php echo $gp['id'];?>" name="permissions[]" value="<?php echo $gp['id'];?>">
									</td>
