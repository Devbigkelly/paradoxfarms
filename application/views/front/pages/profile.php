<div class="container content profile">
			<div class="row">
				<!--Left Sidebar-->
				<?php $this->load->view('front/includes/profile_nav');?>
				<!--End Left Sidebar-->
					...
					<div class="profile-body">
						<div class="profile-bio">
							<div class="row">
								<div class="col-md-5">
									<?php 
									$frm_attributes = array('id' => 'avatar-form', 'name' => 'avatar', 'method' => 'POST');
									echo form_open_multipart('site/upload-avatar', $frm_attributes); ?>
									<input type="file" id="avatar" name="file" accept="image/jpeg" style="display:none; width: 1px; height: 1px" />
									<?php echo form_close();?>
									<script>
									...
									<img class="img-responsive md-margin-bottom-10" onclick="document.getElementById('avatar').click(); return false" src="<?php echo $this->user_account->get_avatar($this->session->userdata('user_id'));?>" alt="">
