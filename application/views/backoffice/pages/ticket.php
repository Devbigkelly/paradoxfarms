          ...
          <div class="col-md-9">
			  ...
			  <div class="card-body">
				...
				<?php } else {?>
                  <div class="direct-chat-msg right">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-right"><?php echo $this->user_account->user_name($this->session->userdata('user_name'));?></span>
                      <span class="direct-chat-timestamp float-left"><?php echo $this->general->time_ago($m['updated']);?></span>
                    </div>
                    <img class="direct-chat-img" src="<?php echo $this->user_account->get_small_pic($this->session->userdata('user_name'));?>" alt="Message User Image">
                    <div class="direct-chat-text">
                      <?php if ($m['is_attachment'] == 1){?>
						<img style="max-width:250px;" src="<?php echo base_url($m['text']);?>">
					  <?php } else {?>
			...
			<?php if ($ticket[0]['status'] == 'open'){?>
				<div class="card-footer" style="text-align: right;">
                    <form method="post" action="<?php echo base_url('member/support/send-message');?>">
					...
					echo form_open_multipart('member/support/attachment', $frm_attributes); ?>
